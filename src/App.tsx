  ...
  return (
    <HelmetProvider>
      <BrowserRouter>
        <ScrollToTop />
        <Helmet
          titleTemplate="%s | Amara Muebles"
          defaultTitle="Amara Muebles | Muebles artesanales de madera en Cochabamba, Bolivia"
        >
          <meta name="description" content="Muebles artesanales de cedro, roble y maderas alternativas tallados a mano por maestros bolivianos. Sofás, comedores, mesas y sillones. Colcapirhua, Cochabamba." />
        </Helmet>
        <Routes>
